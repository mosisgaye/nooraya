import { Flight, SearchParams, FilterOptions, ApiResponse } from '@/types';

class FlightService {
  private baseUrl = process.env.NEXT_PUBLIC_API_URL || '/api';

  async searchFlights(params: SearchParams): Promise<ApiResponse<{flights: Flight[], totalCount: number}>> {
  ...
  filterFlights(flights: Flight[], filters: FilterOptions): Flight[] {
